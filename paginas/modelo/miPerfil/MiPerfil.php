        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="../paginas/carrito.php">CARRITO</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="pago.php">PAGO</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="../paginas/ContactoPerfil.php">CONTÁCTENOS</a>
                    </li>
                    <li>
